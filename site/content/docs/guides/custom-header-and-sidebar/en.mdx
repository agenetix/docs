...
Agenetix Docs now ships one docs layout. When you need different chrome, override the `header` or `sidebar` props instead of switching to another layout wrapper.
