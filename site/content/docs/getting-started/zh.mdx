...
```tsx
import { DocsPage, DocsHomePage } from "@agenetix/docs";
import { docsSource } from "@/lib/docs";
...
---
title: "快速开始"
description: "你的第一篇 MCP Stack Docs 页面"
order: 0
---
...
- [自定义 Header 与 Sidebar](guides/custom-header-and-sidebar) - 当需要时用你自己的组件替换默认 chrome
