...
>
  MCP Stack Docs ships a headless theme engine. Pass a static `theme` prop to `DocsLayout`, or wrap the layout in `DocsThemeProvider` when users should edit, persist, or share theme state.
</Banner>
