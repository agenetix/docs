...
export function resolveDocsTheme(theme?: DocsThemeConfig): DocsResolvedTheme {
  ...
  const style: Record<string, string> = {
    "--agenetixdocs-background": tokens.background,
    "--agenetixdocs-foreground": tokens.foreground,
    "--agenetixdocs-card": tokens.card,
    "--agenetixdocs-card-foreground": tokens.cardForeground,
    "--agenetixdocs-popover": tokens.popover,
    "--agenetixdocs-popover-foreground": tokens.popoverForeground,
    "--agenetixdocs-primary": tokens.primary,
    "--agenetixdocs-primary-foreground": tokens.primaryForeground,
    "--agenetixdocs-secondary": tokens.secondary,
    "--agenetixdocs-secondary-foreground": tokens.secondaryForeground,
    "--agenetixdocs-muted": tokens.muted,
    "--agenetixdocs-muted-foreground": tokens.mutedForeground,
    "--agenetixdocs-accent": tokens.accent,
    "--agenetixdocs-accent-foreground": tokens.accentForeground,
    "--agenetixdocs-destructive": tokens.error,
    "--agenetixdocs-border": tokens.border,
    "--agenetixdocs-border-strong": tokens.borderStrong,
    "--agenetixdocs-input": tokens.input,
    "--agenetixdocs-ring": tokens.ring,
    "--agenetixdocs-info": tokens.info,
    "--agenetixdocs-info-soft": tokens.infoSoft,
    "--agenetixdocs-warning": tokens.warning,
    "--agenetixdocs-warning-soft": tokens.warningSoft,
    "--agenetixdocs-error": tokens.error,
    "--agenetixdocs-error-soft": tokens.errorSoft,
    "--agenetixdocs-success": tokens.success,
    "--agenetixdocs-success-soft": tokens.successSoft,
    "--agenetixdocs-surface": tokens.surface,
    "--agenetixdocs-bg": tokens.bg,
    "--agenetixdocs-accent-soft": tokens.accentSoft,
    "--agenetixdocs-shadow-sm": tokens.shadowSm,
    "--agenetixdocs-shadow-lg": tokens.shadowLg,
    "--agenetixdocs-code-bg": tokens.codeBg,
    "--agenetixdocs-code-border": tokens.codeBorder,
    "--agenetixdocs-layout-width": config.layout.layoutWidth,
    "--agenetixdocs-content-width": config.layout.contentWidth,
    "--agenetixdocs-sidebar-width": config.layout.sidebarWidth,
    "--agenetixdocs-toc-width": config.layout.tocWidth,
    "--agenetixdocs-header-height": densityVars.headerHeight,
    "--agenetixdocs-page-padding": densityVars.pagePadding,
    "--agenetixdocs-sidebar-padding": densityVars.sidebarPadding,
    "--agenetixdocs-section-gap": densityVars.sectionGap,
    "--agenetixdocs-nav-gap": densityVars.navGap,
    "--agenetixdocs-card-padding": densityVars.cardPadding,
    "--agenetixdocs-control-padding-y": densityVars.controlPaddingY,
    "--agenetixdocs-control-padding-x": densityVars.controlPaddingX,
    "--agenetixdocs-toc-padding-y": densityVars.tocPaddingY,
    "--agenetixdocs-toc-padding-x": densityVars.tocPaddingX,
    "--agenetixdocs-page-grid-gap": densityVars.pageGridGap,
    "--agenetixdocs-hue": `${accentHue}`,
