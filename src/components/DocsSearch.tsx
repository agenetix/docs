...
export default function DocsSearch({
  ...
  return (
    <div ref={containerRef} className="agenetixdocs-search">
      <div className="agenetixdocs-search-input-wrap">
        <svg className="agenetixdocs-search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        />
        {variant === "desktop" ? <span className="agenetixdocs-search-kbd">⌘K</span> : null}
      </div>

      {search.isOpen && search.trimmedQuery.length > 0 ? (
        <div className="agenetixdocs-search-panel">
          <DocsSearchResults
